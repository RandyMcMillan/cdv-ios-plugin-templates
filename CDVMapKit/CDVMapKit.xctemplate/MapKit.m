...
- (void)createView
{
	...
	[self.childView setAlpha:0.0];

	self.imageButton = [UIButton buttonWithType:UIButtonTypeCustom];
	self.imageButton.autoresizingMask = (UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleBottomMargin);
...
- (void)setMapData:(NSMutableArray *)arguments withDict:(NSMutableDictionary *)options;	\
	...
	CGRect frame = CGRectMake([self viewController].view.bounds.size.width - 44.0, 20.0, 29.0, 29.0);
